...
public final class PrattCalculatorImproved {
  ...
  private static double factorial(double left) {
    double result = 1;
  ...
  public static double nud(Token tempToken) {
    switch (tempToken.type) {
      ...
      case START_BRACKET:
        ...
        return val;
      case END_BRACKET:
        throw new IllegalArgumentException("Unnecessary brackets: there isn't anything in brackets.");
      default:
    ...
    while (current < exp.length()) {
      ...
      switch (c) {
        ...
        case '^':
          ...
          break;
        case '!':
          tokens.add(new Token(c + "", Symbol.FACTORIAL));
          break;
        case '.':
